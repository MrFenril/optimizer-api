...
module Interpreters
  class SplitClustering
    ...
    def self.split_solve(service_vrp, job = nil, &block)
      ...
      sub_first.resolution_vehicle_limit = ((vrp.resolution_vehicle_limit || vrp.vehicles.size) * (0.10 + sub_first.services.size.to_f / vrp.services.size)).to_i
      ...
      if sub_second
        ...
        sub_second.resolution_vehicle_limit = ((vrp.resolution_vehicle_limit || vrp.vehicles.size) * (0.10 + sub_second.services.size.to_f / vrp.services.size)).to_i
